...
async def encode(filepath):
    ...
    # Codec and Bits
    codec = '-c:v libx264  -metadata 'title=@animedualaudiozippercartoonist Telegram -metadata:s:v title="@animecolony" -metadata:s:a title="@animecolony" -metadata:s:s title="@animecolony" -pix_fmt yuv420p"'
